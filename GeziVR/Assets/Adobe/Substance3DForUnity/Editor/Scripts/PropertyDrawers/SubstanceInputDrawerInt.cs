...
namespace Adobe.SubstanceEditor
{
    ...
    internal static class SubstanceInputDrawerInt
    {
            ...
            else
            {
                switch (content.Description.WidgetType)
                {
                    case SubstanceWidgetType.ToggleButton:
                        changed = DrawToggleButton(valueProperty, content as SubstanceNumericalInputGUIContent, out value);
                        break;

                    case SubstanceWidgetType.Slider:
                        changed = DrawSlider(valueProperty, content as SubstanceNumericalInputGUIContent, out value);
                        break;

                    case SubstanceWidgetType.ComboBox:
                        changed = DrawComboBox(valueProperty, content as SubstanceNumericalInputGUIContent, out value);
                        break;
        ...
        /// <returns>True if value changed.</returns>
        private static bool DrawToggleButton(SerializedProperty valueProperty, SubstanceNumericalInputGUIContent content, out int newValue)
        {
            newValue = 0;
        ...
        /// <param name="content">GUI content.</param>
        /// <returns>True if value changed.</returns>
        private static bool DrawSlider(SerializedProperty valueProperty, SubstanceNumericalInputGUIContent content, out int newValue)
        {
        ...
        /// <param name="content">GUI content.</param>
        /// <returns>True if value changed.</returns>
        private static bool DrawComboBox(SerializedProperty valueProperty, SubstanceNumericalInputGUIContent content, out int newValue)
        {
